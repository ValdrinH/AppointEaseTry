...
namespace AppointEase.Application.Services
{
    ...
    {
    //    private readonly IRepository <TblPacient> _personRepository;
    //    private readonly IMapper _mapper;
    //    private readonly IValidator<PersonDto> _personDtoValidator;

        //public PersonService(IRepository personRepository, IMapper mapper, IValidator<PersonDto> personDtoValidator)
        //{
